...
export default function CategoryCard({ category, itemCount = 0, to }) {
  return (
    <motion.div whileHover={{ y: -3 }} whileTap={{ scale: 0.98 }}>
      <Link
        to={to}
        className="group relative block overflow-hidden rounded-2xl text-left shadow-sm transition-all hover:shadow-md hover:ring-1 hover:ring-gold-500/40 focus:outline-none focus-visible:ring-2 focus-visible:ring-gold-500"
      >
